    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel_long', models.DecimalField(decimal_places=6, default=0, max_digits=9)),
                ('hotel_lat', models.DecimalField(decimal_places=6, default=0, max_digits=9)),
                ('hotel_email', models.EmailField(max_length=254)),
                ('hotel_url', models.URLField()),
                ('hotel_description', models.TextField(default='...')),
                ('admin', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Администратор')),
            ],
        ),
        migrations.CreateModel(
            name='RoomTypes',
            fields=[
                ...
                ('room_type_price', models.DecimalField(decimal_places=2, max_digits=6)),
            ],
        ),
        migrations.CreateModel(
            name='Rooms',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('coefficient', models.DecimalField(decimal_places=2, max_digits=7)),
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotelcontent.hotel')),
            ],
        ),
        migrations.CreateModel(
