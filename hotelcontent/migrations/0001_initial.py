# Generated by Django 3.2.5 on 2021-08-11 22:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel_image', models.ImageField(null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_date', models.DateField(default=datetime.date(2021, 8, 12))),
                ('end_date', models.DateField(default=datetime.date(2021, 8, 12))),
