    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amenity_price', models.DecimalField(decimal_places=2, default=50, max_digits=7)),
            ],
        ),
        migrations.CreateModel(
            name='BookingStatus',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_date', models.DateField(default=datetime.date(2021, 7, 28))),
                ('end_date', models.DateField(default=datetime.date(2021, 7, 28))),
                ('coef', models.DecimalField(decimal_places=2, default=1.1, max_digits=7)),
