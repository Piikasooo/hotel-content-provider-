# Generated by Django 3.2.5 on 2021-08-06 13:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_date', models.DateField(default=datetime.date(2021, 8, 6))),
                ('end_date', models.DateField(default=datetime.date(2021, 8, 6))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotels', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='hotelcontent.hotel')),
                ('room', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='hotelcontent.rooms')),
            ],
        ),
        migrations.AddField(
            model_name='amenity',
